...
extern void Init();
extern bool FindShenmue3(void);
#ifdef _DEBUG
extern void DebugCode();
#endif
extern void UpdateModListThread();
extern void RequestModListUpdate();
extern void UI_Render();

extern bool bActive;
extern bool dragWindow;
...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T(APP_STR), NULL };
	::RegisterClassEx(&wc);
	HWND hwnd = ::CreateWindowExW(0, wc.lpszClassName, _T(APP_STR), WS_POPUPWINDOW, 100, 100, SCR_WIDTH, SCR_HEIGHT, NULL, NULL, wc.hInstance, NULL);
    ...
    //IM_ASSERT(font != NULL);
    ImFont* font = io.Fonts->AddFontFromFileTTF("NotoSansCJKjp-Medium.otf", 18.0f, NULL, io.Fonts->GetGlyphRangesJapanese());
